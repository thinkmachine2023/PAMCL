...
我们在发布前进行了多轮代码审查，针对约束 CAUTION 完整性、热重载语义、Manifest 验证深度、审计容错、Dashboard 安全性等多个方面完成了系统性修复与加固。当前测试数量 **121** 且全部通过。
...
**https://github.com/thinkmachine/PAMCL**
...
我们把它开源，是希望能和更多做过程工业智能化、做具身智能、做物理世界闭环控制的同学一起把这个事情做得更好。
...
- GitHub: https://github.com/thinkmachine/PAMCL
- 文档: 仓库内 README + docs/
- 实验平台: https://www.thinkmachine.cn/labs/
